...
public:
    ...
    : Node("camera_subscriber_node")
    {
        subscription_ = this->create_subscription<sensor_msgs::msg::Image>(
            "/simple_drone/bottom/image_raw", 10, std::bind(&camera_subscriber::camera_callback, this, std::placeholders::_1));
...
private:
    ...
    void camera_callback(const sensor_msgs::msg::Image::SharedPtr camera_msg)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "contours.size() = %d", int(contour.size()));
